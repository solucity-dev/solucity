...
const styles = StyleSheet.create({
  ...
  backBtn: {
    ...
    paddingHorizontal: 16, justifyContent: 'center', height: '100%',
  },
  ...
  title: { color: '#fff', fontSize: 30, fontWeight: '800', letterSpacing: 0.2, marginTop: 12, textAlign: 'center' },
  ...
  card: {
    ...
    backgroundColor: 'rgba(255,255,255,0.92)', elevation: 2,
    shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 8, shadowOffset: { width: 0, height: 2 },
  },
  cardIconBubble: {
    width: 44, height: 44, borderRadius: 12, backgroundColor: 'rgba(1,90,105,0.09)',
