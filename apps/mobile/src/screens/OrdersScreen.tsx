        ...
        <View style={styles.filters}>
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ gap: 8 }}>
            ...
            {(['all', 'active', 'expired'] as const).map((d) => {
              const on = deadline === d
              const label = d === 'all' ? 'Límites: Todos' : d === 'active' ? 'A tiempo' : 'Vencidos'
              return (
                <Pressable
                  key={d}
            ...
            {list.map((o) => {
              ...
              return (
                ...
                >
                  ...
                  <View style={styles.row}>
                    <Ionicons name="flash-outline" size={16} color={o.isUrgent ? '#ffe164' : '#E9FEFF'} />
...
const styles = StyleSheet.create({
  ...
  chip: {
    borderWidth: 1, borderColor: 'rgba(233,254,255,0.65)',
  ...
  chipAlt: {
    borderWidth: 1, borderColor: 'rgba(255, 225, 100, 0.65)',
    borderRadius: 999, paddingHorizontal: 12, paddingVertical: 6,
  },
  ...
  retryBtn: {
    marginTop: 10, backgroundColor: '#E9FEFF',
